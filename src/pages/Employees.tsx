...
export function Employees() {
  ...
  const [department, setDepartment] = useState<'HR' | 'Accounts' | 'Operational' | 'Administrative' | 'General'>('Operational');
              ...
              <table className="min-w-full divide-y divide-slate-200">
                ...
                <tbody className="bg-white divide-y divide-slate-200">
                  {employees.length === 0 ? (
                    ...
                    employees.map((emp) => (
                      <tr key={emp.uid} className={cn("hover:bg-slate-50 transition-colors", !emp.isActive && "opacity-60")}>
